...
const pages = [
  { file: "hero-desktop.png", label: "Desktop (1440 × 900)", dim: "1440 × 900", full: true },
  { file: "hero-tablet.png",  label: "Tablet (768 × 1024)",  dim: "768 × 1024" },
  { file: "hero-mobile.png",  label: "Mobile (390 × 844)",   dim: "390 × 844" },
];
...
<head>
  ...
  <title>Hero Section — Responsive Screenshots</title>
  <style>
...
<body>
  <h1>Hero Section — Responsive Screenshots</h1>
  <p class="subtitle">Desktop · Tablet · Mobile</p>
...
writeFileSync(join(DIR, "gallery-hero.html"), html);
console.log(`✅ Built gallery-hero.html (${Math.round(html.length / 1024)} KB)`);
