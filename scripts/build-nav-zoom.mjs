...
const buf = readFileSync('snapshots/nav-zoom.png');
...
<div class="card"><h3>NAV BAR — 1440px viewport</h3><img src="data:image/png;base64,${b64}" /></div>
</body></html>`;
writeFileSync('public/gallery-nav-zoom.html', html);
console.log('Done');
