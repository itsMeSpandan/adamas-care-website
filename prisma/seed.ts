...
const servicesData = [
  {
    ...
    durationMinutes: 60,
    price: 85,
    imageUrl: "/images/photo-1560066984-138dadb4c035",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 120,
    price: 180,
    imageUrl: "/images/photo-1522337360788-8b13dee7a37e",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 75,
    price: 150,
    imageUrl: "/images/photo-1570172619644-dfd03ed5d881",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 90,
    price: 195,
    imageUrl: "/images/photo-1616394584738-fc6e612e71b9",
    featured: false,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 45,
    price: 55,
    imageUrl: "/images/photo-1604654894610-df63bc536371",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 60,
    price: 75,
    imageUrl: "/images/photo-1519014816548-bf5fe059798b",
    featured: false,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 90,
    price: 130,
    imageUrl: "/images/photo-1544161515-4ab6ce6db874",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 75,
    price: 145,
    imageUrl: "/images/photo-1515377905703-c4788e51af15",
    featured: false,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 180,
    price: 450,
    imageUrl: "/images/photo-1519741497674-611481863552",
    featured: true,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
  {
    ...
    durationMinutes: 60,
    price: 250,
    imageUrl: "/images/photo-1487412720507-e7ab37603c6f",
    featured: false,
    employeeIds: ["priya-sharma", "kavya-iyer", "rahul-verma", "arjun-mehta"],
  },
];

// All 10 service IDs — every specialist can perform every service.
const ALL_SERVICE_IDS = [
  "precision-haircut", "color-gloss-treatment", "hydra-facial", "anti-aging-facial",
  "gel-manicure", "nail-art-design", "deep-tissue-massage", "aromatherapy-body-wrap",
  "bridal-glam-package", "pre-wedding-skincare",
];
...
const bookingsData = [
  ...
  { serviceId: "color-gloss-treatment", employeeId: "kavya-iyer", userId: null, date: bookingDate(11, 12), timeSlot: "14:00 - 16:00", slotStart: "14:00", slotEnd: "16:00", name: "Farhan Sheikh", email: "farhan@example.com", phone: "+91 98765 43211", notes: null, status: "completed" as const, price: 180, rating: 5, review: null },
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(11, 20), timeSlot: "11:00 - 12:30", slotStart: "11:00", slotEnd: "12:30", name: "Deepak Nair", email: "deepak@example.com", phone: "+91 98765 43212", notes: "Shoulder pain", status: "completed" as const, price: 130, rating: 4, review: null },
  ...
  { serviceId: "gel-manicure", employeeId: "priya-sharma", userId: null, date: bookingDate(10, 22), timeSlot: "13:00 - 13:45", slotStart: "13:00", slotEnd: "13:45", name: "Simran Kaur", email: "simran@example.com", phone: "+91 98765 43215", notes: null, status: "completed" as const, price: 55, rating: 4, review: null },
  ...
  { serviceId: "nail-art-design", employeeId: "rahul-verma", userId: null, date: bookingDate(9, 25), timeSlot: "14:00 - 15:00", slotStart: "14:00", slotEnd: "15:00", name: "Tanya Ghosh", email: "tanya@example.com", phone: "+91 98765 43218", notes: null, status: "completed" as const, price: 75, rating: 5, review: null },
  // 8 months ago (Oct 2025)
  { serviceId: "precision-haircut", employeeId: "kavya-iyer", userId: null, date: bookingDate(8, 2), timeSlot: "10:00 - 11:00", slotStart: "10:00", slotEnd: "11:00", name: "Karan Malhotra", email: "karan@example.com", phone: "+91 98765 43219", notes: null, status: "completed" as const, price: 85, rating: 4, review: null },
  { serviceId: "aromatherapy-body-wrap", employeeId: "arjun-mehta", userId: null, date: bookingDate(8, 10), timeSlot: "15:00 - 16:15", slotStart: "15:00", slotEnd: "16:15", name: "Divya Chopra", email: "divya@example.com", phone: "+91 98765 43220", notes: null, status: "completed" as const, price: 145, rating: 5, review: null },
  { serviceId: "bridal-glam-package", employeeId: "kavya-iyer", userId: null, date: bookingDate(8, 18), timeSlot: "08:00 - 11:00", slotStart: "08:00", slotEnd: "11:00", name: "Pallavi Das", email: "pallavi@example.com", phone: "+91 98765 43221", notes: "Wedding day", status: "completed" as const, price: 450, rating: 5, review: "Flawless!" },
  ...
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(7, 4), timeSlot: "11:00 - 12:30", slotStart: "11:00", slotEnd: "12:30", name: "Vikram Joshi", email: "vikram@example.com", phone: "+91 98765 43223", notes: null, status: "completed" as const, price: 130, rating: 5, review: null },
  ...
  { serviceId: "gel-manicure", employeeId: "priya-sharma", userId: null, date: bookingDate(6, 8), timeSlot: "15:00 - 15:45", slotStart: "15:00", slotEnd: "15:45", name: "Ayesha Khan", email: "ayesha@example.com", phone: "+91 98765 43228", notes: null, status: "completed" as const, price: 55, rating: 4, review: null },
  { serviceId: "nail-art-design", employeeId: "rahul-verma", userId: null, date: bookingDate(6, 15), timeSlot: "11:00 - 12:00", slotStart: "11:00", slotEnd: "12:00", name: "Priti Sengupta", email: "priti@example.com", phone: "+91 98765 43229", notes: null, status: "completed" as const, price: 75, rating: 5, review: null },
  ...
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(5, 3), timeSlot: "10:00 - 11:30", slotStart: "10:00", slotEnd: "11:30", name: "Rajan Pillai", email: "rajan@example.com", phone: "+91 98765 43231", notes: null, status: "completed" as const, price: 130, rating: 4, review: null },
  { serviceId: "color-gloss-treatment", employeeId: "kavya-iyer", userId: null, date: bookingDate(5, 10), timeSlot: "13:00 - 15:00", slotStart: "13:00", slotEnd: "15:00", name: "Gayatri Rao", email: "gayatri@example.com", phone: "+91 98765 43232", notes: null, status: "completed" as const, price: 180, rating: 5, review: null },
  ...
  { serviceId: "aromatherapy-body-wrap", employeeId: "rahul-verma", userId: null, date: bookingDate(5, 24), timeSlot: "15:00 - 16:15", slotStart: "15:00", slotEnd: "16:15", name: "Usha Pillai", email: "usha@example.com", phone: "+91 98765 43234", notes: null, status: "completed" as const, price: 145, rating: 5, review: null },
  ...
  { serviceId: "bridal-glam-package", employeeId: "kavya-iyer", userId: null, date: bookingDate(4, 14), timeSlot: "09:00 - 12:00", slotStart: "09:00", slotEnd: "12:00", name: "Mitali Sen", email: "mitali@example.com", phone: "+91 98765 43236", notes: null, status: "completed" as const, price: 450, rating: 5, review: null },
  { serviceId: "gel-manicure", employeeId: "priya-sharma", userId: null, date: bookingDate(4, 20), timeSlot: "12:00 - 12:45", slotStart: "12:00", slotEnd: "12:45", name: "Tanvi Shah", email: "tanvi@example.com", phone: "+91 98765 43237", notes: null, status: "completed" as const, price: 55, rating: 4, review: null },
  ...
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(3, 5), timeSlot: "11:00 - 12:30", slotStart: "11:00", slotEnd: "12:30", name: "Ashok Mishra", email: "ashok@example.com", phone: "+91 98765 43239", notes: null, status: "completed" as const, price: 130, rating: 5, review: null },
  ...
  { serviceId: "nail-art-design", employeeId: "priya-sharma", userId: null, date: bookingDate(3, 19), timeSlot: "13:00 - 14:00", slotStart: "13:00", slotEnd: "14:00", name: "Ishita Das", email: "ishita@example.com", phone: "+91 98765 43241", notes: null, status: "completed" as const, price: 75, rating: 5, review: null },
  ...
  { serviceId: "precision-haircut", employeeId: "kavya-iyer", userId: null, date: bookingDate(2, 3), timeSlot: "10:00 - 11:00", slotStart: "10:00", slotEnd: "11:00", name: "Nitin Srivastava", email: "nitin@example.com", phone: "+91 98765 43243", notes: null, status: "completed" as const, price: 85, rating: 4, review: null },
  ...
  { serviceId: "aromatherapy-body-wrap", employeeId: "arjun-mehta", userId: null, date: bookingDate(2, 17), timeSlot: "14:00 - 15:15", slotStart: "14:00", slotEnd: "15:15", name: "Geeta Devi", email: "geeta@example.com", phone: "+91 98765 43245", notes: null, status: "completed" as const, price: 145, rating: 5, review: null },
  ...
  { serviceId: "gel-manicure", employeeId: "rahul-verma", userId: null, date: bookingDate(2, 30), timeSlot: "15:00 - 15:45", slotStart: "15:00", slotEnd: "15:45", name: "Sana Mirza", email: "sana@example.com", phone: "+91 98765 43247", notes: null, status: "completed" as const, price: 55, rating: 4, review: null },
  ...
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(1, 9), timeSlot: "10:00 - 11:30", slotStart: "10:00", slotEnd: "11:30", name: "Girish Kumar", email: "girish@example.com", phone: "+91 98765 43249", notes: null, status: "completed" as const, price: 130, rating: 5, review: null },
  ...
  { serviceId: "nail-art-design", employeeId: "priya-sharma", userId: null, date: bookingDate(1, 28), timeSlot: "13:00 - 14:00", slotStart: "13:00", slotEnd: "14:00", name: "Nandini Singh", email: "nandini@example.com", phone: "+91 98765 43252", notes: null, status: "completed" as const, price: 75, rating: 5, review: null },
  // Current month (Jun 2026)
  { serviceId: "bridal-glam-package", employeeId: "kavya-iyer", userId: null, date: bookingDate(0, 2), timeSlot: "09:00 - 12:00", slotStart: "09:00", slotEnd: "12:00", name: "Swati Reddy", email: "swati@example.com", phone: "+91 98765 43253", notes: null, status: "completed" as const, price: 450, rating: 5, review: null },
  { serviceId: "color-gloss-treatment", employeeId: "kavya-iyer", userId: null, date: bookingDate(0, 5), timeSlot: "13:00 - 15:00", slotStart: "13:00", slotEnd: "15:00", name: "Kamal Nath", email: "kamal@example.com", phone: "+91 98765 43254", notes: null, status: "completed" as const, price: 180, rating: 5, review: null },
  ...
  { serviceId: "deep-tissue-massage", employeeId: "arjun-mehta", userId: null, date: bookingDate(0, 10), timeSlot: "11:00 - 12:30", slotStart: "11:00", slotEnd: "12:30", name: "Hari Prasad", email: "hari@example.com", phone: "+91 98765 43256", notes: null, status: "confirmed" as const, price: 130, rating: null, review: null },
  { serviceId: "gel-manicure", employeeId: "priya-sharma", userId: null, date: bookingDate(0, 12), timeSlot: "15:00 - 15:45", slotStart: "15:00", slotEnd: "15:45", name: "Ritu Goel", email: "ritu@example.com", phone: "+91 98765 43257", notes: null, status: "confirmed" as const, price: 55, rating: null, review: null },
